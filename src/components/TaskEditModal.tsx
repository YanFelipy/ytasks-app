        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className="edit-window-controls flex justify-between">
                ...
                <div className=" px-2 py-2 sm:flex sm:flex-row sm:px-4">
                  <button
                    ...
                    className="inline-flex  justify-center rounded-md bg-white  py-2 text-sm font-semibold text-gray-900 shadow-xs hover:ring-1 ring-gray-300 ring-inset hover:bg-gray-50 sm:mt-0 sm:w-auto"
                  >
              ...
              <div
                className="bg-white px-2 pt-2 pb-2 sm:p-2 sm:pb-4 flex
              justify-center"
              >
