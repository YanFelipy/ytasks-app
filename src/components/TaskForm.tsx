...
console.log(selectedDate)
  ...
  <label className="flex flex-col items-start w-65" >
    ...
    <input name="nameTask"  onChange={onInputChange} placeholder="Insira sua tarefa"  className="block min-w-0 rounded-md grow border border-gray-900/10  py-1.5  pl-1 text-base text-gray-900 placeholder:text-gray-400 placeholder:text-gray-400 w-60" type="text" />
  </label>

   <label className="flex flex-col items-start w-40">
    <span className="mb-2">Dificuldade da tarefa :</span>
    <input name="difficulty" onChange={onInputChange} className="block  min-w-0 rounded-md grow border border-gray-900/10  py-1.5  pl-1 text-base text-gray-900 placeholder:text-gray-400 placeholder:text-gray-400  w-40"  placeholder="Insira de 0 a 10" min="0" max="10" type="number" />
  </label>
...
<div className="flex gap-1">
  <label className="flex flex-col items-start w-60">
    ...
    <input  name="date" onChange={onInputChange} className="block min-w-0 rounded-md grow border border-gray-900/10  py-1.5  pl-1 text-base text-gray-900 placeholder:text-gray-400 placeholder:text-gray-400  w-50 " type="datetime-local" />
  </label>
